...
export const loadServiceRequests = createAction('[ServiceRequest] Load ServiceRequests');
...
export const filterServiceRequests = createAction(
  ...
  props<{ filters: { status?: string; priority?: string; city?: string; createdBy: number } }>()
);
...
export const updateServiceRequest = createAction(
  ...
  props<{ id: number, payload: ServiceRequestModel }>()
);
